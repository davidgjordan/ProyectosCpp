...
Layer::Layer(int numNodes,LayerType layerType,uniform_real_distribution<double>& distribution,default_random_engine& generator):transitionType{transitionType},layerType{layerType}
{
    ...
    for(int nodes = 0; nodes < numNodes ; nodes++)
    {
        layerPerceptron.push_back(new Perceptron {INPUTS_PER_NODE,function,distribution,generator});
    }
}
