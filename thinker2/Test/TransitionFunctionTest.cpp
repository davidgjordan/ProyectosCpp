...
class TransitionFunctionTest : public :: testing :: Test
{
    protected:
...
TEST_F(TransitionFunctionTest, TransitionByStepGivingNumber)
{
...
TEST_F(TransitionFunctionTest, TransitionSigmoidGivingNumbers)
{
    //Arrange
...
TEST_F(TransitionFunctionTest, TransitionHiperbolicTangentGivingNumbers)
 {
    //Arrange
...
TEST_F(TransitionFunctionTest, TransitionSoftMaxGivingNumbers)
 {
...
TEST_F(TransitionFunctionTest, CalculateDerivedTransitionByStep)
{
    Transition* transitionByStep = new TransitionByStep();
...
TEST_F(TransitionFunctionTest, CalculateDerivedTransitionHT)
{
...
TEST_F(TransitionFunctionTest, CalculateDerivedTransitionSigmoid)
{
...
TEST_F(TransitionFunctionTest, CalculateDerivedSoft)
{
