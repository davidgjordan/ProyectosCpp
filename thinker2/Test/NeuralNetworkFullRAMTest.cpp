...
class NeuralNetworkFullRAMTest : public ::testing::Test 
{
    
};

TEST_F(NeuralNetworkFullRAMTest, FullRAMtoDatesNeuralNetworkInput)
{
    
	SourceFullRAM* dataSource = new SourceFullRAM();
...
TEST_F(NeuralNetworkFullRAMTest, FullRAMtoInputsOutputsNeuralNetwork)
{
    ...
    SourceFullRAM* dataSource = new SourceFullRAM(true);
    ...
    int inputsNodesExpected = 4;
    float inputsExpected [] = {112.000000, 114.000000, 115.000000, 48.000000};
