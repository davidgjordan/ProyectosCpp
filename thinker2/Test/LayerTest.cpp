...
uniform_real_distribution <double> _distribution{-1,1};
...
TEST(LayerTest, BuildHiddenLayer)
 {
 	int nodes = 4;
 	int inputs = 1;
	Layer* hidden = new Layer{nodes,inputs,TypeOfTransition::TANGHIPERBOLIC,LayerType::HIDDEN,_distribution,_generator};
...
TEST(LayerTest,OutputLayerWithSigmoidMultiplesInputs)
{
 	int nodes = 2;
 	int inputs = 2;
	Layer * out = new Layer{nodes,inputs,TypeOfTransition::SIGMOID,LayerType::OUTPUT,_distribution,_generator};
...
TEST(LayerTest,InputLayerWithMultiplesInputs)
{
 	int nodes = 5;
 	int inputs = 1;
	Layer * layer = new Layer{nodes,inputs,TypeOfTransition::SIGMOID,LayerType::INPUT,_distribution,_generator};
